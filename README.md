## PLH CodeData
Foi criado um repositório para organizar todos os trabalhos da Squad em um único local, utilizando a técnica de subtree do Git para integrar todos os projetos. Este é um projeto relacionado ao TCC do curso técnico de Desenvolvimento de Sistemas.
...
## Diagramas
Os diagramas podem ser visualizados diretamente pelo link abaixo ou baixar para consulta offline clicando neste [link](/Documentação/Diagramas).
...
## Sprints
Ao final de cada Sprint, será criada uma nova branch nomeada como 'Sprint<Número da Sprint>' para registrar o estado do projeto correspondente a essa fase.

## Aplicação
Você pode acessar o site da aplicação clicando neste [link](https://codedata-connection-b3g2d0e4dkcrdzcp.brazilsouth-01.azurewebsites.net/).
