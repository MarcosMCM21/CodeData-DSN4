        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AspNetUsers_GerenteID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Localizacao = table.Column<string>(type: "POINT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Tipo = table.Column<bool>(type: "TINYINT(1)", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipamentos_Documentos_DocumentoId",
                        column: x => x.DocumentoId,
                        principalTable: "Documentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Equipamentos_Estoques_EstoqueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contratos_Documentos_DocumentoId",
                        column: x => x.DocumentoId,
                        principalTable: "Documentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contratos_Solicitacoes_SolicitacaoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovimentacoesEquipamentos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovimentacoesEquipamentos_Documentos_DocumentoId",
                        column: x => x.DocumentoId,
                        principalTable: "Documentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovimentacoesEquipamentos_Enderecos_EnderecoId",
                        column: x => x.EnderecoId,
                        principalTable: "Enderecos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovimentacoesEquipamentos_Equipamentos_EquipamentoId",
                        column: x => x.EquipamentoId,
                        principalTable: "Equipamentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovimentacoesEquipamentos_Solicitacoes_SolicitacaoId",
                        column: x => x.SolicitacaoId,
                        principalTable: "Solicitacoes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contratos_DocumentoId",
                table: "Contratos",
                column: "DocumentoId");

            migrationBuilder.CreateIndex(
                name: "IX_Contratos_SolicitacaoId",
                table: "Contratos",
                column: "SolicitacaoId");

            migrationBuilder.CreateIndex(
                name: "IX_Equipamentos_DocumentoId",
                table: "Equipamentos",
                column: "DocumentoId");

            migrationBuilder.CreateIndex(
                name: "IX_Equipamentos_EstoqueId",
                table: "Equipamentos",
                column: "EstoqueId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovimentacoesEquipamentos_DocumentoId",
                table: "MovimentacoesEquipamentos",
                column: "DocumentoId");

            migrationBuilder.CreateIndex(
                name: "IX_MovimentacoesEquipamentos_EnderecoId",
                table: "MovimentacoesEquipamentos",
                column: "EnderecoId");

            migrationBuilder.CreateIndex(
                name: "IX_MovimentacoesEquipamentos_EquipamentoId",
                table: "MovimentacoesEquipamentos",
                column: "EquipamentoId");

            migrationBuilder.CreateIndex(
                name: "IX_MovimentacoesEquipamentos_SolicitacaoId",
                table: "MovimentacoesEquipamentos",
                column: "SolicitacaoId");
